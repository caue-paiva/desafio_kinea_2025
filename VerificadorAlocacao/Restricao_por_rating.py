...
fundo_teste = lista_fundos[2]

ratings_igual_abaixo = get_ratings_igual_abaixo("Aaa", mapeamento_fundos_tabela_car[dict_fundos_tipoCAR[fundo_teste]])
...
a = spark.sql(query_sum_positions_por_fundo)
a.show()
